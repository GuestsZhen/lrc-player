...
// node_modules/.pnpm/@lrc-maker+lrc-parser@0.1.17/node_modules/@lrc-maker/lrc-parser/build/esm/lrc-parser.js
var parser = (lrcString, option = {}) => {
...
var storedFormatter = /* @__PURE__ */ new Map();
var getFormatter = (fixed) => {
...
var convertTimeToTag = (time, fixed, withBrackets = true) => {
  if (time === void 0) {
    return "";
  }
...
var formatText = (text, spaceStart, spaceEnd) => {
  let newText = text;
  if (spaceStart >= 0) {
...
//# sourceMappingURL=@lrc-maker_lrc-parser.js.map
