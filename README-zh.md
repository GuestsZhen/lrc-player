...
# [简谱 lrc 播放器][lrc player] &middot; [![Build](https://github.com/magic-akari/lrc-player/actions/workflows/build.yml/badge.svg)](https://github.com/magic-akari/lrc-player/actions/workflows/build.yml)
...
打开 [lrc-player][lrc player] 即可开始，你可以把这个链接收藏到浏览器书签。将文件拖放到页面中加载，使用箭头键和空格键插入时间戳。
